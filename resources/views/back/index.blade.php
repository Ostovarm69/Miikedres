                                            ...
                                            <div class="card-body">
                                                <ul class="list-group">
                                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                                        حجم تصاویر محتوای اشغالی
                                                        <span class="badge badge-primary badge-pill">{{$fileSize}} MB</span>
                                                    </li>
                                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                                        تعداد محصولات در انتظار بروزرسانی
                                                        <span class="badge badge-primary badge-pill">{{$robotStateCount}}</span>
                                                    </li>
                                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                                        تخمین زمانی اتمام بروزرسانی
                                                        <span class="badge badge-primary badge-pill">حدودا {{ ceil($robotStateCount/40) }} دقیقه</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
