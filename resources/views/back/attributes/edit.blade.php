                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="color" class="form-control" name="value2" value="{{ $attribute->value2 }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" name="color2" type="checkbox" id="defaultCheck1" {{ $attribute->value2 ? 'checked':''  }}>
