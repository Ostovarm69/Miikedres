                                ...
                                <div class="tab-content">
                                    ...
                                    <form id="information-form" action="{{ route('admin.settings.information') }}" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <fieldset class="form-group">
                                                    <label for="basicInputFile">لوگوی شرکت صفحه ورود و ثبت نام</label>
                                                    <div class="custom-file">
                                                        <input type="file" accept="image/*" name="login_logo" class="custom-file-input">
                                                        <label class="custom-file-label" for="inputGroupFile01">{{ option('login_logo') }}</label>
                                                        <p><small>بهترین اندازه <span class="text-danger">{{ config('front.imageSizes.logo') }}</span> پیکسل میباشد.</small></p>
                                                    </div>
                                                </fieldset>
                                            </div>
