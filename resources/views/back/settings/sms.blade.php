                                    ...
                                    <form id="sms-form" action="{{ route('admin.settings.sms') }}" method="POST">
                                        ...
                                        <div class="row my-2 mb-4">
                                            ...
                                            <div class="form-group col-md-4">
                                                <fieldset class="checkbox">
                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                        <input data-class="birth_day_sms" type="checkbox" name="birth_day_sms" {{ option('birth_day_sms') == 'on' ? 'checked' : '' }} >
                                                        <span class="vs-checkbox">
                                                            <span class="vs-checkbox--check">
                                                                <i class="vs-icon feather icon-check"></i>
                                                            </span>
                                                        </span>
                                                        <span class="">ارسال پیامک تبریک تولد</span>
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <fieldset class="checkbox">
                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                        <input data-class="comment_sms" type="checkbox" name="comment_sms" {{ option('comment_sms') == 'on' ? 'checked' : '' }} >
                                                        <span class="vs-checkbox">
                                                            <span class="vs-checkbox--check">
                                                                <i class="vs-icon feather icon-check"></i>
                                                            </span>
                                                        </span>
                                                        <span class="">ارسال پیامک برای ثبت نظر سفارشات</span>
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <fieldset class="checkbox">
                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                        <input data-class="notification_sms" type="checkbox" name="notification_sms" {{ option('notification_sms') == 'on' ? 'checked' : '' }} >
                                                        <span class="vs-checkbox">
                                                            <span class="vs-checkbox--check">
                                                                <i class="vs-icon feather icon-check"></i>
                                                            </span>
                                                        </span>
                                                        <span class="">ارسال پیامک برای اطلاعیه</span>
                                                    </div>
                                                </fieldset>
                                            </div>
                                        </div>
