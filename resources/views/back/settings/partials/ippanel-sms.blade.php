        ...
        <div class="col-md-6">
            <div class="row">
                <div class="col-md-12 form-group mb-0">
                    ...
                    <div class="input-group mb-75">
                        <input type="text" name="birth_day_pattern_code_ippanel" class="form-control ltr birth_day_sms" value="{{ option('birth_day_pattern_code_ippanel') }}" required>
                    </div>
                </div>
                <div class="col-md-12 form-group">
                    <label>متن نمونه ایجاد پترن</label>
                    <textarea readonly class="form-control birth_day_sms" rows="4">%fullname% عزیز کدتخفیف %amount% درصدی %code% به مناسبت روز تولد شما ایجاد شد.&#13;&#10 {{ option('info_site_title') }}</textarea>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="row">
                ...
                <div class="col-md-12 form-group">
                    <label>متن نمونه ایجاد پترن</label>
                    <textarea readonly class="form-control comment_sms" rows="4">%fullname% عزیز سفارش  %order_id% بدستتان رسیده است . لطفا از لینک زیر وارد شده و نظر خودرا وارد کنید %link%&#13;&#10 {{ option('info_site_title') }}</textarea>
                </div>
            </div>
        </div>
    </div>
