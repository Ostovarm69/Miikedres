<div class="main-menu menu-fixed menu-accordion menu-shadow {{ user_option('theme_color') == 'light' ? 'menu-light' : 'menu-dark' }}" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @can(['client-notifications'])
                <li class="nav-item has-sub {{ open_class(['admin.client-notifications.*']) }}"><a href="#"><i class="feather icon-bell"></i><span class="menu-title"> اطلاعیه ها</span></a>
                    <ul class="menu-content">
                        <li class="{{ active_class('admin.client-notifications.index') }}">
                            <a class="{{ active_class('admin.client-notifications.index') }}" href="{{ route('admin.client-notifications.index') }}"><i class="feather icon-circle"></i><span class="menu-item">لیست اطلاعیه ها</span></a>
                        </li>

                        <li class="{{ active_class('admin.client-notifications.create') }}">
                            <a class="{{ active_class('admin.client-notifications.create') }}" href="{{ route('admin.client-notifications.create') }}"><i class="feather icon-circle"></i><span class="menu-item">ایجاد اطلاعیه</span></a>
                        </li>
                    </ul>
                </li>
            @endcan
            ...
            @can(['robot'])
                <li class="nav-item has-sub {{ open_class(['admin.robot.*']) }}"><a href="#"><i class="feather icon-terminal"></i><span class="menu-title"> تنظیمات ربات </span></a>
                    <ul class="menu-content">
                        <li class="{{ active_class('admin.robot.categories-mapping') }}">
                            <a class="{{ active_class('admin.robot.categories-mapping') }}" href="{{ route('admin.robot.categories-mapping') }}">
                                <i class="feather icon-circle"></i>
                                <span class="menu-item">تنظیمات دسته بندی ها</span>
                            </a>
                        </li>
                        <li class="{{ active_class('admin.robot.setting') }}">
                            <a class="{{ active_class('admin.robot.setting') }}" href="{{ route('admin.robot.setting') }}">
                                <i class="feather icon-circle"></i>
                                <span class="menu-item">تنظیمات بروزرسانی</span>
                            </a>
                        </li>
                    </ul>
                </li>
...
{{--                        @can('settings.sms')--}}
                            <li class="{{ active_class('admin.settings.email') }}">
                                <a href="{{ route('admin.settings.email') }}"><i class="feather icon-circle"></i><span class="menu-item">تنظیمات ایمیل</span></a>
                            </li>
{{--                        @endcan--}}
