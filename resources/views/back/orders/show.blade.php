                ...
                <section class="page-users-view">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">رهگیری محصول</div>
                                </div>
                                <div class="card-body">
                                    <div>
                                        <form method="post" action="{{ route('admin.orders.store-tracking', ['order' => $order]) }}">
                                            {{ csrf_field() }}
                                            <div class="col-12">
                                                <div class="row">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input info_map_type" id="post-tracking" name="type" value="post" checked>
                                                            <label class="custom-control-label" for="post-tracking">ارسال پست</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input info_map_type" id="tipax-tracking" name="type" value="tipax">
                                                            <label class="custom-control-label" for="tipax-tracking">ارسال تیپاکس</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                <input dir="ltr" id="tracking-code" type="text" name="tracking_id" class="form-control text-right">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        <div class="row">
                                                            <dt class="col-md-4">نوع ارسال :</dt>
                                                            <dd class="col-md-8">{{ $orderTracking->type }}</dd>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <div class="row">
                                                            <dt class="col-md-4">کد رهگیری :</dt>
                                                            <dd class="col-md-8">{{ $orderTracking->tracking_id }}
                                                            </dd>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <form method="post" action="{{ route('admin.orders.delete-tracking', ['trackingId' => $orderTracking->id]) }}">
                                                            {{ csrf_field() }}
                                                            {{ method_field('delete') }}
