...
@push('scripts')
    <script>
        ...
        var groupCount = {{ $copy_product ? $copy_product->specificationGroups->unique()->count() : '0' }};
        var specificationCount = {{ $copy_product ? $copy_product->specifications->unique()->count() : '0' }};
