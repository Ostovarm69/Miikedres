...
<head>
    ...
    @if (config('app.debug'))
        ...
        <!-- Main CSS File -->
        <link rel="stylesheet" href="{{ theme_asset('css/main.css') }}?v=26">
        <link rel="stylesheet" href="{{ theme_asset('css/styles.css') }}?v=26">
        <link rel="stylesheet" href="{{ theme_asset('css/custom.css') }}?v=4">
        <!-- endinject -->
...
<body>
    ...
    @if (config('app.debug'))
        ...
        <script src="{{ theme_asset("js/notifications.js") }}?v=12"></script>
    @else
        <!-- All JS Files -->
