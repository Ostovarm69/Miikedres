...
@section('user-content')
    ...
    <div class="col-xl-9 col-lg-8 col-md-8 col-sm-12">
        <div class="row">
                ...
                <div class="col-12">
                    <div class="checkout-alert dt-sn mb-4">
                        ...
                        <div class="checkout-alert-content">
                            <p>
                                <span class="checkout-alert-content-failed">{{ trans('front::messages.profile.system-cancellation') }}</span>
                                <br>
            ...
            @endif
            @if(!$order->orderTracking->isEmpty())
                <div class="col-12">
                    <section class="slider-section dt-sl mb-5">
                        <div class="row mb-3">
                            <div class="col-12">
                                <div class="section-title text-sm-title title-wide no-after-title-wide">
                                    <h2> {{ trans('front::messages.tracking.title') }}</h2>
                                </div>
                            </div>
                            <!-- Start Profile-order-step-Slider -->
                            <div class="col-12">
                                <table class="table table-order table-order-details">
                                    ...
                                    @foreach($order->orderTracking as $orderTracking)
                                        <tr>
                                            <td>
                                                @if($orderTracking->type === 'tipax') تیپاکس @else پست @endif
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="@if($orderTracking->type === 'tipax') https://tipaxco.com/tracking?id={{ $orderTracking->tracking_id }} @else https://tracking.post.ir?id={{ $orderTracking->tracking_id }} @endif" target="_blank" class="btn btn-primary">
