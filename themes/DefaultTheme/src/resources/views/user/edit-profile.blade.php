                ...
                <form id="profile-form" action="{{ route('front.user.profile.update') }}" class="setting_form" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mt-4">
                            ...
                            <div class="form-row form-group">
                                <input type="text" class="input-ui pr-2 date_1 persian-date-picker" name="birth_date" value="{{ $user->birth_date ? jdate($user->birth_date)->getTimestamp() : '' }}" {{ $user->birth_date ? 'disabled' : '' }}>
                            </div>
                        </div>
                        <div class="col-lg-6 mt-4">
                            <div class="form-row-title">
