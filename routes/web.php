...
Route::group(['as' => 'admin.', 'prefix' => 'admin/' . admin_route_prefix(), 'middleware' => ['auth', 'Admin', 'verified', 'CheckPasswordChange', 'password.confirm']], function () {
    ...
    Route::get('products/get-content', [ProductController::class, 'getProductContents'])->name('product.content.index');
    Route::get('products/get-content/download', [ProductController::class, 'getProductDownloadContent'])->name('product.download.content');
    ...
    Route::resource('client-notifications', NotificationController::class);
    Route::post('client-notifications/api/index', [NotificationController::class, 'apiIndex'])->name('client-notifications.apiIndex');
    Route::delete('client-notifications/api/multipleDestroy', [NotificationController::class, 'multipleDestroy'])->name('client-notifications.multipleDestroy');

    // ------------------ robot setting
    Route::get('robot/categories-mapping', [RobotController::class, 'categoriesMapping'])->name('robot.categories-mapping');
    Route::post('robot/categories-mapping', [RobotController::class, 'categoriesMappingStore'])->name('robot.categories-mapping.store');
    Route::get('robot/setting', [RobotController::class, 'setting'])->name('robot.setting');
    Route::get('robot/setting/live-update', [RobotController::class, 'liveUpdate'])->name('robot.setting.live-update');
    Route::post('robot/setting/update-single-product', [RobotController::class, 'updateSingleProduct'])->name('robot.setting.update-single-product');
    Route::post('robot/setting/update-single-product-id', [RobotController::class, 'updateSingleProductById'])->name('robot.setting.update-single-product-id');
    Route::post('robot/setting/update-period', [RobotController::class, 'updatePeriod'])->name('robot.setting.update-period');
    Route::post('robot/setting/update-captions', [RobotController::class, 'storeCaptions'])->name('robot.setting.update-captions');
    ...
    Route::post('/orders/{order}/tracking', [OrderController::class, 'storeTracking'])->name('orders.store-tracking');
    Route::delete('/orders/tracking/{trackingId}', [OrderController::class, 'deleteTracking'])->name('orders.delete-tracking');
    ...
    Route::get('settings/email', [SettingController::class, 'showEmail'])->name('settings.email');
    Route::post('settings/email', [SettingController::class, 'updateEmail'])->name('settings.email.save');
